...
class ProbLabel:
    ...
    def draw(self, canvas, x, y):
        ...
        if (self.text == "E|H"):
            ...
            canvas.create_text(text2X, y, text="(E", font=("Calibri", self.fontSize, ""))
            canvas.create_text(text3X, y, text="|", font=("Calibri", self.fontSize, "bold"))
            canvas.create_text(text4X, y, text="H)", font=("Calibri", self.fontSize, ""))
        ...
        #P(H) with tags
            ...
            text1X = x
            text2X = text1X + self.fontSize
            canvas.create_text(text1X, y, text="P", font=("Calibri", self.fontSize, "bold italic"), tags="canPH")
            canvas.create_text(text2X, y, text="  (H)", font=("Calibri", self.fontSize, ""), tags="canPH")
        ...
        #P(E|NOT-H)
            ...
            canvas.create_text(text2X, y, text="(E", font=("Calibri", self.fontSize, ""))
            canvas.create_text(text3X, y, text="|", font=("Calibri", self.fontSize, "bold"))
            canvas.create_text(text4X, y, text="Not-H)", font=("Calibri", self.fontSize, ""))
